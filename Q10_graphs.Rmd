...
mod<-gls(data=alldata, Q10~ 1+ tempRange + durationDays, na.action = na.omit)
mod2<-lmer(data=alldata, Q10~1+ tempRange + durationDays + (1|uniqueSite), na.action = na.omit)
mod3<-lmer(data=alldata, Q10~1+ tempRange + durationDays + (1|citationKey), na.action = na.omit)
mod4<-lmer(data=alldata, Q10~1+ tempRange + durationDays + (1|citationKey/uniqueSite), na.action = na.omit)
...
#look for optimal random effects
mod<-gls(data=alldata, Q10T~ 1+ tempRange + durationDays, na.action = na.omit)
mod2<-lmer(data=alldata, Q10T~1+ tempRange + durationDays + (1|uniqueSite), na.action = na.omit)
mod3<-lmer(data=alldata, Q10T~1+ tempRange + durationDays + (1|citationKey), na.action = na.omit)
mod4<-lmer(data=alldata, Q10T~1+ tempRange + durationDays + (1|citationKey/uniqueSite), na.action = na.omit)
...
mod4a<-lmer(data=alldata, Q10~1+ tempRange + durationDays + (1|citationKey/uniqueSite), na.action = na.omit,   REML=FALSE)
mod4b<-lmer(data=alldata, Q10~1+ tempRange + (1|citationKey/uniqueSite), na.action = na.omit, REML=FALSE)
AIC(mod4a, mod4b)
anova(mod4a, mod4b)
#gnbbnjk get rid of this later
# length(which(is.na(alldata$tempRange)))
# length(which(is.na(alldata$durationDays)))
