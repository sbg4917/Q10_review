...
##Model
Note that I chose C:N here instead of N as it 
```{r}
...
```
#Figures
Supplementary figure 5: Mean annual temperature versus Δ14C. Two versions one with all fractions and one parsed by fraction. 
...
ggsave("Q10_depthXlandCover.jpeg", width=6, height=3)
